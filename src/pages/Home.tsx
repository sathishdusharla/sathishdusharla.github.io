          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link
                ...
                className="bg-transparent border-2 border-blue-500 text-blue-500 px-8 py-3 rounded-full hover:bg-blue-500/10 transition-all duration-300 transform hover:scale-105"
              >
                Register Now
              </Link>
            </div>
